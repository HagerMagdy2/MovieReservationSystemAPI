        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfMovies = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShowsTime_Halls_hall_id",
                        column: x => x.hall_id,
                        principalTable: "Halls",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShowsTime_Movies_movie_id",
                        column: x => x.movie_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_ShowsTime_showtime_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResevationDetail", x => new { x.reservation_id, x.showtime_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShowsTime_hall_id",
                table: "ShowsTime",
                column: "hall_id");

            migrationBuilder.CreateIndex(
                name: "IX_ShowsTime_movie_id",
                table: "ShowsTime",
                column: "movie_id");
        }
